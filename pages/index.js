...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "" : "dark"}>
      ...
      <main className="bg-white px-10 dark:bg-gradient-to-br dark:from-red-900 dark:via-blue-900 dark:to-yellow-700 md:px-20 lg:px-40">
            ...
            <ul className="flex flex-wrap md:flex-no-wrap items-center">
              ...
              <li className="mb-4">
                <a
                  ...
                  href="/docs/resume" download={true}
                >
                  Resume
                </a>
              </li>
        ...
        <section>
          <div>
            <h1 id="skills" data-aos="fade-up" className="text-3xl py-1 dark:text-white font-extrabold font-serif ui-sans-serif text-center  rounded-lg ">Services I offer</h1>
